...
SOLUTION_CONFIG = AttrDict({
    ...
    'xgboost': {'booster': safe_eval(params.xgb__booster),
                'objective': safe_eval(params.xgb__objective),
                'tree_method': safe_eval(params.xgb__tree_method),
                'eval_metric': safe_eval(params.xgb__eval_metric),
                'eta': safe_eval(params.xgb__eta),
                ...
                'lambda': safe_eval(params.xgb__lambda),
                'alpha': safe_eval(params.xgb__alpha),
                'max_bin': safe_eval(params.xgb__max_bin),
                'num_leaves': safe_eval(params.xgb__max_leaves),
                'nthread': safe_eval(params.num_workers),
                'nrounds': safe_eval(params.xgb__nrounds),
